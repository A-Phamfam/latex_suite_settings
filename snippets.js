[
	...
	{trigger: "@j", replacement: "\\xi", options: "mA"},
	{trigger: "@J", replacement: "\\Xi", options: "mA"},
	...
	{trigger: "ee", replacement: "e^{\\Huge $0 }$1", options: "mA"},
	{trigger: "ej", replacement: "e^{\\Huge j $0 }$1", options: "mA"},
	{trigger: "en", replacement: "e^{\\Huge -j $0 }$1", options: "mA"},
	{trigger: "sn", replacement: "^{-}$1", options: "mA"},
	{trigger: "sp", replacement: "^{+}$1", options: "mA"},
    {trigger: "invs", replacement: "^{-1}", options: "mA"},
    {trigger: /([A-Za-z])(\d)/, replacement: "[[0]]_{[[1]]}", options: "rmA", description: "Auto letter subscript", priority: -1},

    {trigger: /([^\\])(exp|log|ln)/, replacement: "[[0]]\\[[1]]", options: "rmA"},
    {trigger: "conj", replacement: "^{*}", options: "mA"},
    {trigger: "Re", replacement: "\\mathrm{Re}\\{$0\\}", options: "mA"},
	{trigger: "Im", replacement: "\\mathrm{Im}\\{$0\\}", options: "mA"},
    ...
    {trigger: "dint", replacement: "\\int_{${0:0}}^{${1:1}} $3 \\, d${2:x} $4", options: "mA"},
	...
	{trigger: "jbes(\d|n|m|p)", replacement: "j_[[0]] ($0) $1", options: "rmA"},
	{trigger: "ybes(\d|n|m|p)", replacement: "y_[[0]] ($0) $1", options: "rmA"},
	{trigger: "Ibes(\d|n|m|p)", replacement: "I_[[0]] ($0) $1", options: "rmA"},
	{trigger: "Kbes(\d|n|m|p)", replacement: "K_[[0]] ($0) $1", options: "rmA"},
	{trigger: "Pleg(\d|n|m|p)", replacement: "P_[[0]] ($0) $1", options: "rmA"},
	{trigger: "Qleg(\d|n|m|p)", replacement: "Q_[[0]] ($0) $1", options: "rmA"},
	...
	{trigger: "([a-zA-Z])tens", replacement: "\\overline{\\overline{[[0]]}}", options: "rmA"},
	...
	{trigger: "tens", replacement: "\\overline{\\overline{$0}}$1", options: "mA"},
	...
	{trigger: "\\\\(${GREEK}|${SYMBOL}) tens", replacement: "\\overline{\\overline{\\[[0]]}}", options: "rmA"},
	...
	{trigger: "xm2", replacement: "x_{n-2}", options: "mA"},
	...
	{trigger: "simas", replacement: "\\overset{$0}{\\simeq} $1", options: "mA"},
	...
	{trigger: "att", replacement: "|_{$0} $1", options: "mA"},
